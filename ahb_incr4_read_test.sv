...
class ahb_incr4_read_test extends iot_test_base;
  `uvm_component_utils(ahb_incr4_read_test)
  ...
  task run_phase(uvm_phase phase);
    ...
    ahb_incr4_read_seq master_seq1;
...
#40000;
    ...
    master_seq1 = ahb_incr4_read_seq::type_id::create("master_seq1");
